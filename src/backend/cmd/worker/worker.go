...
func run(cmd *cobra.Command, args []string) {
	...
	for {
		...
		var err error
		busrabbitmqurl, err := beego.AppConfig.String("BusRabbitMQURL")
		if err != nil {
			logs.Error("beego.AppConfig.String('BusRabbitMQURL')", err.Error())
			continue
		}
		bus.DefaultBus, err = bus.NewBus(busrabbitmqurl)
		if err != nil {
