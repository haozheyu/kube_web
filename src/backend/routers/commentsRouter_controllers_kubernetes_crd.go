...
func init() {
	const KubeCRDController = "kube_web/controllers/kubernetes/crd:KubeCRDController"
	...
	const KubeCustomCRDController = "kube_web/controllers/kubernetes/crd:KubeCustomCRDController"
