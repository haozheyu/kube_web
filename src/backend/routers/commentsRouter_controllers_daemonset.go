...
func init() {
	const DaemonSetController = "kube_web/controllers/daemonset:DaemonSetController"
	...
	const DaemonSetTplController = "kube_web/controllers/daemonset:DaemonSetTplController"
