...
func init() {
	const PersistentVolumeClaimController = "kube_web/controllers/pvc:PersistentVolumeClaimController"
	...
	const PersistentVolumeClaimTplController = "kube_web/controllers/pvc:PersistentVolumeClaimTplController"
